...
const props = defineProps({
    ...
    companies: Array, // Lista de compañías disponibles
    can: Object,
});
...
const form = useForm({
    ...
    role_id: '', // Ya se usaba correctamente
});

const submit = () => {
    form.post(route('employees_users.store'), {
...
<template>
    <Head title="Crear Empleado y Usuario" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crear Nuevo Empleado y Usuario</h2>
        </template>
