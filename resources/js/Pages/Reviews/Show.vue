            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    ...
                    <div class="flex justify-end space-x-2 mt-6">
                        ...
                        <Link v-if="can.create_reviews" :href="route('reviews.edit', [order.id, review.id])" class="inline-flex items-center px-4 py-2 bg-yellow-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-yellow-600 focus:bg-yellow-600 active:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 transition ease-in-out duration-150">
                            Editar Revisión
                        </Link>
                        <DangerButton v-if="can.create_reviews" @click="confirmDelete()">
                            Eliminar Revisión
                        </DangerButton>
                    </div>
                </div>
