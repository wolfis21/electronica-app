...
import Checkbox from '@/Components/Checkbox.vue'; // Importar Checkbox si lo usas
...
const newProductForm = useForm({
    ...
    code: '',
    description: '',
    price: null, // Precio de costo
    price_sale: '', // Precio de venta
    is_service: false,
    stock: 0,
});

// Lógica para manejar el stock cuando se marca/desmarca "Es un servicio"
...
<template>
    ...
    <AuthenticatedLayout>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                    <form @submit.prevent="submit">
                        <!-- ... (Sección Descripción y Responsable sin cambios) ... -->
                        <div class="mb-4">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <PrimaryButton :class="{ 'opacity-25': form.processing }" :disabled="form.processing">Crear Revisión</PrimaryButton>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <!-- MODAL PARA CREAR NUEVO PRODUCTO/SERVICIO (ACTUALIZADO) -->
